 <?php require_once __DIR__ . "/../layouts/header.php"; ?>
  ...
  <div class="secciones">
    ...
    <div class="page-sub">Seleccione para validacion o anulada</div>
     <div class="row g-3">
    <?php if(empty($borrador)){ ?>

      <div class="alert alert-info py-2">
          NO HAY NOTICIAS SUBIDAS A BORRADOR
        </div>
    ...
    <?php foreach($borrador as $noticia){ ?>
        ...
        <div class="card-box p-4">
          ...
          <div class="d-flex gap-2">
            <form action="index.php?c=noticia&a=cambiarEstado" method="post">
              ...
              <button class="btn btn-success btn-sm" type="submit" name="validarBoton">Lista para validacion</button>
              <button class="btn btn-outline-warning btn-sm" type="submit" name="anularBoton">Anular</button>
            </form>
